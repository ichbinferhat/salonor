  ...
  return (
    ...
    >
      {reviews.map((r) => (
        <figure
          key={r.id}
          className="flex h-full w-[82%] shrink-0 snap-start flex-col rounded-[24px] border border-line bg-surface p-6 shadow-card sm:w-[calc((100%_-_1.25rem)/2)] lg:w-[calc((100%_-_3.75rem)/4)]"
        >
